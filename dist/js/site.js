...
function next() {
  ...
  if (question_count == questions.length - 1) {
    ...
    location.href = "https://patnot.com/practice/end.html";
  }
  question_count++;
  show(question_count);
}
...
<div class="state">
    ...
    <div>
          <button onclick="showcalculator()" class="btn-next cal" id="myBtn">calculator1</button>
          </div>
          `
  ...
  sts.innerHTML=`<h4>${count+1}/20</h4>`;
  question.innerHTML = `
  <h2>Q${count + 1}. ${questions[count].question}</h2>
  <p>
  <img src=${questions[count].queimg} alt="hu" onerror="this.style.display='none'"   style="width:50%;height:50%;">
</p>
...
<p>
  <img src=${questions[count].img} alt=" " onerror="this.style.display='none'" style="width:50%;height:50%;">
</p>
</details>
